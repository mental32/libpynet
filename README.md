...
The pynet_framework is designed as a furter extension to the discord.py commands extension.

It can be treated as both a bot instance and a python module since you may access `pynet.utils` without modifying any internal state.
